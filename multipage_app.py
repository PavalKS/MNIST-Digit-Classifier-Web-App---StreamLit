...
def main():
    ...
    page = st.sidebar.selectbox("Choose a page", ["How The Neural Network Works", "Interactive Neural Network", "Upload Custom Image to Neural Network"])
    if page == "How The Neural Network Works":
        st.session_state.page = "How The Neural Network Works"
        home_page()
    elif page == "Interactive Neural Network":
        st.session_state.page = "Interactive Neural Network"
        page1()
    elif page == "Upload Custom Image to Neural Network":
        st.session_state.page = "Upload Custom Image to Neural Network"
        page2()
...
def page1():
    ...
    st.write("Change these parameters and see how your choices affect the accuracy of the model!")
